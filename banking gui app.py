...
def register():
    ...
    Label(register_screen, text="OP Balance:", font=('Calibri',12)).grid(row=5,sticky=W)
    ...
    Entry(register_screen,textvariable=temp_balance).grid(row=5,column=0)


    #Buttons
    Button(register_screen, text="Register", command =(finish_reg, finish_deposit), font=('Calibri',12)).grid(row=7,sticky=N,pady=10)
